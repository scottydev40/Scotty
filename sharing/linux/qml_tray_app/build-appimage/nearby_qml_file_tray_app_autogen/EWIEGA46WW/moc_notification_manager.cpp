...
template <> constexpr inline auto NotificationManager::qt_create_metaobjectdata<qt_meta_tag_ZN19NotificationManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'OnActionInvoked'
        QtMocHelpers::SlotData<void(uint, const QString &)>(1, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::UInt, 3 }, { QMetaType::QString, 4 },
        }}),
        // Slot 'OnNotificationClosed'
        QtMocHelpers::SlotData<void(uint, uint)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
...
void NotificationManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->OnActionInvoked((*reinterpret_cast<std::add_pointer_t<uint>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 1: _t->OnNotificationClosed((*reinterpret_cast<std::add_pointer_t<uint>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<uint>>(_a[2]))); break;
        default: ;
        }
    }
}
